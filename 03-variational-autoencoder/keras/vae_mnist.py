...
from keras import datasets, layers, losses, metrics, models


# sample latent space in gaussian distribution
...
mins, maxs = np.min(embeddings, axis=0.5), np.max(embeddings, axis=0)
